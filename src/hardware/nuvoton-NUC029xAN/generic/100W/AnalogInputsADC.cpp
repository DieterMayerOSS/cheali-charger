...
const adc_correlation order_analogInputs_on[] PROGMEM = {
    ...
    {-1,                            OUTPUT_VOLTAGE_PIN,     AnalogInputs::Vout_plus_pin,   false},
    ...
    {-1,                            SMPS_CURRENT_PIN,       AnalogInputs::Ismps,           true},
    {MADDR_V_GND_REF,               MUX0_Z_D_PIN,           AnalogInputs::Vb0_pin,         false},
    {-1,                            T_EXTERNAL_PIN,         AnalogInputs::Textern,         false},
    {MADDR_V_OUTMUX,                MUX0_Z_D_PIN,           AnalogInputs::VoutMux,         false},
    {-1,                            SMPS_CURRENT_PIN,       AnalogInputs::Ismps,           true},
